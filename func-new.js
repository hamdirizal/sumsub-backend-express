transformDataForExternalServices(applicantData){
  let finalObj:any = {}
  ...
  finalObj.incorporationCountry = this.alpha3toAlpha2(qtr?.sections?.companyInformation?.items?.countryOfIncorporation?.value);
  ...
  if (!finalObj.externalUserId) {
    finalObj.externalUserId = finalObj.externalId;
  }
